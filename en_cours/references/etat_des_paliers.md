...
* **Un quiz ou un dialogue ne renseignent jamais au-delà du palier 2** (`activites_type/quiz.md`) : cocher la bonne réponse, ou donner un exemple pertinent, n'est pas produire sous contrainte réelle.
