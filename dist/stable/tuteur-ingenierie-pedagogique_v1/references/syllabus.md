...
* **Portée de A1/A2/A3** : le syllabus n’est pas lui-même une activité évaluée. En revanche, dès qu’il décrit une évaluation, une progression ou des prérequis, ceux-ci doivent être compatibles avec l’état des paliers et les clauses A1/A2/A3 de `taxonomie.md`. Le détail des contrôles s’applique ensuite au niveau des activités évaluées.
* **La modalité n'est jamais implicite** : le champ « Volume horaire & Modalités » du Bloc A pilote tout le découpage en aval (`decoupage_pedagogique.md` §0) — c'est lui qui décide si le module comporte des Séances (synchrone) ou directement des Ateliers / Quiz / Reculs (asynchrone). À faire confirmer par l'utilisateur avant de descendre d'un niveau.
